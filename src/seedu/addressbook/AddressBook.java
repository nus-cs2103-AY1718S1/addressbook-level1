...
//    private static final String PERSON_PROPERTY_PHONE = "phone";
    ...
    // Replaces PERSON_PROPERTY_<PROPERTY> with enums variant
    ...
    private static String executeSortPerson(String commandArgs) {
        ArrayList<HashMap<PersonProperty, String>> targetPersonList = ALL_PERSONS;

        ArrayList<String> personNames = new ArrayList<String> ();
        HashMap<String, HashMap<PersonProperty, String>> bruteHash = new HashMap<String, HashMap<PersonProperty, String>> ();
        for (HashMap<PersonProperty, String> person: targetPersonList) {
