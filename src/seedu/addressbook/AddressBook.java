...
public class AddressBook {
    ...
    /**
     * Adds a group (specified by the command args) to the address book.
     * The entire command arguments string is treated as a string representation of the group to add.
     *
     * @param commandArgs full command args string from the user
     * @return feedback display message for the operation result
     */
    ...
    /**
     * Constructs a feedback message for a successful add group command execution.
     *
     * @see #executeAddGroup(String)
     * @param addedGroup group that was successfully added
     * @return successful add group feedback message
     */
     ...
     */
    private static ArrayList<HashMap<PersonProperty, String>> getPersonsWithNameContainingAnyKeyword(Collection<String>
                                                                                                      keywords) {
    ...
    */
    ...
    private static void addPersonToAddressBook(HashMap<PersonProperty, String> person) {
        HashMap<PersonProperty,String> details = new HashMap<>();
        details.put(PersonProperty.NAME, person.get(PersonProperty.NAME));
        details.put(PersonProperty.PHONE, person.get(PersonProperty.PHONE));
        details.put(PersonProperty.EMAIL, person.get(PersonProperty.EMAIL));
        ALL_PERSONS.add(details);
