...
class Person {
     ...
     */
    enum PersonProperty {NAME, PHONE, EMAIL}

    /**
     * The HashMap storage system for the properties.
     */
     ...
     * @param email - String value of the person's email.
     */
     ...
     */
    String getProperty(PersonProperty key) {
